 ...
 *
 * - In the function layout add brightness modifications on k and l
 */
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FL] = LAYOUT_iso(
    ...
    _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, _______, KC_BRIU, KC_BRID, _______, _______, _______, _______, KC_END,  \
