 ...
 * Custom keycodes
 */
// Keycodes to switch to an active application window
// These keycodes are used in Ubuntu's shortcut manager and call a script using wnctrl
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |----------------------------------------------------------------|
   * |Ctrl|Win |Alt |          Space        |Alt|FN2|Ctrl|Lef|Dow|Rig |
   * `----------------------------------------------------------------'
   *
